...
import logoMain from '../assets/sunhill-secure-logo.png'
...
import heroImage from '../assets/sunhill-secure-hero.webp'
...
const faqItems = [
  {
    ...
    answer:
      'Choose Sunhill Secure VPN Premium for classic VPN usage with reliable regional routing and the strongest day-to-day performance.',
  },
  {
    question: 'What data does Sunhill Secure VPN collect?',
    answer:
      'Sunhill Secure VPN focuses on privacy-first architecture and minimal telemetry required for service quality and support.',
  },
  {
    question: 'Is Sunhill Secure VPN a free app?',
    answer:
      'Yes. You can use Sunhill Secure VPN Free. Premium adds paid fast locations and additional convenience features.',
  },
  {
    question: 'A lot is blocked in my country, what is suitable for me?',
    answer:
      'Use Sunhill Secure VPN Free for restricted regions first, then switch to Premium for more locations and higher speed when needed.',
  },
  {
    question: 'Which Sunhill Secure VPN services let me choose a protocol?',
    answer:
      'Advanced plans support secure protocol options, including SunhillWG and Xray-based routes for custom scenarios.',
  },
]
...
const staticPages = {
  ...
  '/about': {
    ...
    description:
      'Sunhill Secure VPN helps people connect privately, bypass network restrictions, and browse with clear controls and secure technology.',
    image: heroImage,
    imageAlt: 'Sunhill Secure VPN app interface',
    highlights: [
      'Privacy-first VPN tools for individuals and teams',
      'Free and premium VPN options',
      'Focused on access, security, and practical reliability',
    ],
  },
  '/premium-discount': {
    eyebrow: 'SPECIAL OFFER',
    title: 'Switch to Sunhill Secure VPN Premium with a 50% discount',
    description:
      'Move from a VPN that stopped working to Sunhill Secure VPN Premium and get fast regional routing, stronger protocols, and support for everyday private access.',
    image: change50Image,
    imageAlt: '50 percent discount',
    highlights: [
      'Premium VPN locations with high-speed access',
      'Supports SunhillWG and XRay VLESS Reality protocols',
        ...
        <main className="mx-auto w-full max-w-[2200px] px-[15px] pb-12 pt-10 sm:px-5 md:px-[30px] md:pt-16 xl:px-[70px]">
          {currentPath === '/blog' ? (
            <section className="min-h-[58vh]">
              <SectionHeading title="Sunhill Secure VPN Blog" align="left" />
              <div className="mt-8">
                <BlogCard
      ...
      <main className="mx-auto w-full max-w-[2200px] px-[15px] pb-12 pt-10 sm:px-5 md:px-[30px] md:pt-20 xl:px-[70px]">
              ...
              <ProductCard
                ...
                features={[
                  ...
                  },
                  {
                    ...
                    text: 'Supports SunhillWG 1.5 and XRay VLESS Reality protocols',
                  },
            ...
            <div id="free" className="scroll-mt-24">
              <ProductCard
                ...
                features={[
                  ...
                  { icon: <Cpu className="h-6 w-6 md:h-[30px] md:w-[30px]" />, text: 'Supports SunhillWG 1.5 protocol' },
                ]}
              />
            </div>
          </div>
          ...
          <div id="business" className="mt-6 grid scroll-mt-24 overflow-hidden rounded-[20px] border border-[#192331] bg-[#050910] lg:grid-cols-[1fr_1.15fr]">
            <div className="p-5 sm:p-6 md:p-12">
              <h3 className="text-[24px] font-bold text-[#f0f2f6] md:text-[32px]">
                Sunhill Secure VPN <span className="text-[#0067ff]">Business</span>
              </h3>
        ...
        <section id="promotions" className="mt-20 scroll-mt-24">
          ...
          <div className="mt-8 grid gap-4 md:grid-cols-3">
            <article id="switch-discount" className="scroll-mt-24 rounded-[20px] border border-[#1a2433] bg-[#171d29] p-5 sm:p-6 md:p-8">
              ...
              <p className="mt-4 text-[16px] leading-[1.5] text-[#98a0af] sm:text-[18px] md:text-[22px]">Switch to Sunhill Secure VPN Premium with a 50% discount</p>
            ...
            <article className="rounded-[20px] border border-[#1a2433] bg-[#050910] p-5 sm:p-6 md:p-8">
              ...
              <h3 className="mt-6 text-[20px] font-medium leading-[1.2] text-[#edf0f5] sm:text-[22px] md:mt-8 md:text-[24px] lg:text-[28px]">
                New locations in Sunhill Secure VPN <span className="text-[#df138f]">Premium</span>
              </h3>
            ...
            <article className="rounded-[20px] border border-[#1a2433] bg-[#050910] p-5 sm:p-6 md:p-8">
              <img src={wgV2Image} alt="SunhillWG v2.0" className="w-[88%] max-w-[280px] object-contain" />
              <h3 className="mt-6 text-[20px] font-medium leading-[1.2] text-[#edf0f5] sm:text-[22px] md:mt-8 md:text-[24px] lg:text-[28px]">Updated SunhillWG 2.0 Protocol</h3>
              <p className="mt-4 text-[16px] leading-[1.5] text-[#98a0af] sm:text-[18px] md:text-[22px]">
        ...
        <section id="downloads" className="mt-20 grid scroll-mt-24 items-center gap-12 lg:grid-cols-[0.9fr_1fr]">
          <div className="relative mx-auto">
            ...
            <img src={phonePromoImage} alt="Sunhill Secure VPN app screen" className="relative mx-auto w-[220px] sm:w-[280px] md:w-[420px]" />
          ...
          <div>
            ...
            <p className="mt-5 max-w-[680px] text-[16px] leading-[1.5] text-[#9ea6b4] sm:text-[17px] md:mt-6 md:text-[20px]">
              With Sunhill Secure VPN, you can connect to our classic Premium service or get free access to blocked websites with the Free service.
            </p>
          </div>
        </section>
        ...
        <section id="security" className="mt-20 grid scroll-mt-24 gap-4 md:grid-cols-2">
          <FeatureCard
            ...
            description="The SunhillWG protocol combines the speed and performance of the popular WireGuard protocol with additional protection against detection and blocking. The source code is available at Github"
            image={awgGlowImage}
            imageAlt="SunhillWG"
          />
          <FeatureCard
        ...
        <section id="press" className="mt-20 scroll-mt-24 text-center md:mt-24">
          <h2 className="text-[30px] font-extrabold text-[#e9ebf0] sm:text-[34px] md:text-[48px]">They write about Sunhill Secure VPN</h2>
          ...
          <div className="flex h-[min(760px,calc(100vh-32px))] w-full max-w-[480px] flex-col overflow-hidden rounded-[20px] border border-[#1a2434] bg-[#050910] shadow-[0_24px_60px_rgba(0,0,0,0.45)]">
            <div className="flex items-center justify-between border-b border-[#172234] px-4 py-3">
              <div>
                ...
                <p className="mt-0.5 text-[13px] text-[#9ea7b6]">Sunhill Secure VPN Premium</p>
              </div>
              <button
                type="button"
